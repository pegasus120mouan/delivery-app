...
@section('title', 'Boutiques actives')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Liste des boutiques actives</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <!--   Début container pour le menu -->
    <div class="block-container">
       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addBoutiqueModal" disabled>
          <i class="fa fa-user-plus"></i> Enregistrer une boutique
      </button>
  


       <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#add-point" disabled>
