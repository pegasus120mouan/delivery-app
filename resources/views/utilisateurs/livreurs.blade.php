        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <h3>{{ $livreurs->where('role', 'livreurs')->count() }}</h3>
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addUserModal">
     ...
     <table id="example2" class="table table-bordered table-hover">
             ...
             <tbody>
                ...
                <tr>
                    <td>
                        <a href="{{ route('utilisateurs.profile', $livreur->id) }}">
                            <img src="{{ asset('storage/utilisateurs/' . $livreur->avatar) }}" 
                                alt="Avatar" 
                                class="img-circle" 
                    ...
                    <td>
                        <a href="{{ route('utilisateurs.edit', $livreur->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                        <form action="{{ route('utilisateurs.destroy', $livreur->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
